...
type FOCUS_AREA_CAROUSEL_PROPS={
  cards: PATHWAY_CARD[];
  cardBgColor: string;
}
function FocusAreaCarousel(props:FOCUS_AREA_CAROUSEL_PROPS) {
  ...
  return (
    <div className="focus-area-carousel">
...
export default FocusAreaCarousel;