  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1100px] mx-auto mt-10 bg-[#FBF4EF] rounded-[28px] px-16 py-14">
        ...
        {/* Sub heading */}
        <p className="text-[#0F4F58] text-[30px] font-bold font-[RocaTwo]">
          Your team’s new ritual is here!{" "}
        </p>

        {/* Description */}
        <p className="mt-4 text-[#0F4F58] text-[21px] max-w-[900px] leading-relaxed ml-[40px] font-[Roboto]">
          This is what your Champion chose based on everyone’s input. You’ll be
          practising it together over the coming weeks — at a pace that works
          for your team.
        </p>

        {/* Yellow Poll Box */}
        <div className="bg-[#F5C882] rounded-[20px] p-8 space-y-6">
          {/* Focus Area */}
            ...
            <div className="mt-[70px]">
              <button className="relative">
                ...
                <Image
                  ...
                  width={50}
                  height={50}
                  className="absolute -top-[36px] -right-[34px] -rotate-[46deg]"
                />
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#F5F0EB] rounded-[18px] p-6 max-w-[381px]">
                ...
                <p className="text-[18px] font-[Aptos] font-[400] text-[#244E52] mb-4">
                  ...
                  problems — it means approaching them with a bit more
                  generosity and curiosity first.
                </p>
        ...
        <div className="mt-12 px-10">
          ...
          <div className="flex justify-end mt-10">
            <div className="w-[420px]">
              ...
              {/* Progress Text */}
              <p className="text-[15px] mt-3 text-center text-[#000000] font-bold font-[Aptos]">
          ...
          <p className="mt-12 text-[21px] font-bold text-[#000000] font-[League Spartan] ">
            Over time, teams pause to reflect on what’s helping — and what’s
            worth keeping.
          </p>
