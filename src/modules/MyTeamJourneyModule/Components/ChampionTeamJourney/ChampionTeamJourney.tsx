...
import styles from "./ChampionTeamJourney.module.css";
      ...
      >
        ...
        <div className="max-w-[1100px] mx-auto mt-[80px] bg-[#FBF4EF] rounded-[28px] px-12 py-10 relative ">
          ...
          <p className="text-[#0F4F58] text-[30px] font-[400] font-[RocaTwo]">
            This section is where team members explore the focus areas, rituals
            and reflections chosen for their team.
          </p>

          {/* Description */}
          <p className="mt-6 text-[#0F4F58] text-[22px] leading-relaxed font-[Roboto] ml-[40px]">
            As a Champion, you help shape this journey from your Hub.
          </p>
...
export default ChampionTeamJourney;
