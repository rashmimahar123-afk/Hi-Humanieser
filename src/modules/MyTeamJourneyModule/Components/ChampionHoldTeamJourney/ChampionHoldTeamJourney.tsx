...
import styles from "./ChampionHoldTeamJourney.module.css";
...
type CHAMPION_HOLD_TEAM_JOURNEY_PROPS = {
  pollData?: GET_MTJ_POLL_RESPONSE;
  profileData?: MY_PROFILE_RESPONSE;
};

function ChampionHoldTeamJourney(props: CHAMPION_HOLD_TEAM_JOURNEY_PROPS) {
      ...
      >
        ...
        <div className="max-w-[1100px] mx-auto mt-[80px] bg-[#FBF4EF] rounded-[28px] px-12 py-10 relative ">
          ...
          <p className="text-[#4ba6a6] text-[31px] font-[700] font-[RocaTwo]">
            {` Hold Tight ${profileData?.first_name || ""}, your team is currently answering the team poll, a space where everyone’s voice helps shape what the team focuses on next.`}
          </p>

          {/* Description */}
          <p className="mt-6 text-[#0F4F58] text-[22px] leading-relaxed font-[Roboto] ml-[40px]">
            Once the poll is ready, suggested Focus Areas will become available
            to you in the Champion Hub.
          </p>
          ...
          <div className="mt-12 bg-[#f5c882] rounded-[18px] px-12 py-4 max-w-[900px] ml-[55px] gap-6">
            ...
            <div>
              <p className="text-[#0f4f58] text-[22px] whitespace-nowrap font-[Aptos]">
                In the meantime, you can visit your
              </p>
            </div>
            {/* Center CTA */}
      ...
      "
            ...
            <div className="flex justify-end -mr-[46px]">
              <p className="text-[#0f4f58] text-[22px] max-w-[360px] font-[Aptos]">
                to start polls, select rituals, and guide your teams through the
                process.
              </p>
            </div>
          </div>
...
export default ChampionHoldTeamJourney;
