      ...
      <div className="px-8 py-6">
        <div className="max-w-[1100px]">
          ...
          <p className="mt-6 text-[21px] text-[#0f4f58] max-w-[750px] leading-relaxed font-[Roboto]">
            Making expectations, priorities and communication clear so everyone
            knows where they stand and what they’re working toward.
          </p>
        </div>
          ...
          <div className="w-[600px] relative">
            ...
            <div className="relative z-10">
              ...
              <p className="text-[#0F4F58] text-[19px] leading-relaxed font-[Roboto] mt-3">
                ...
                priorities. Clear direction reduces friction, speeds execution,
                and helps effort translate into results.
              </p>
            </div>
          </div>
        </div>
