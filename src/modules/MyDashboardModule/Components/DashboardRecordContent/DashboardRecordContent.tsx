...
type DASHBOARD_RECORD_CONTENT_PROPS = {
  firstName?: string;
  ...
  activePracticeList: Array<PRACTICE_LIST_ITEM>;
  teamRituals: Array<MTJ_TEAM_RITUAL_DATA>;
  activeFocusArea?: FOCUS_AREA_DATA;
          ...
          {topStrengthDetails?.length === 0 ? (
            <div className="bg-[#ffffff] pt-[1px] px-[16px] sm:px-[28px] md:px-[45px] pb-[15px] mt-[50px] border rounded-[10px]">
              <div className="flex justify-between mt-[60px] ">
                ...
                {/* Retake Button */}
                <div className="cursor-pointer" onClick={onRetakeQuiz}>
                  <PolygonButton
                    width="126px"
                    height="107px"
                    bgColor="#F6E3BF"
              ...
              <div>
                <div>
                  ...
                  <p className="text-[#737373] font-[Aptos]text-[20px] mt-[10px]">
                    {`${firstName}, from what you shared, a few things are already coming through strongly:`}
                  </p>
                      ...
                      <div className="grid grid-cols-3 gap-[40px]">
                        {weakStrengthDetails.map((item: any, index: any) => (
                          <QuizPathwayCards
                            ...
                            onLearnMore={() => onLearnMore?.(item.title)}
                            bgColor={"#CDE3CC"}
                          />
                        ))}
                      </div>
...
export default DashboardRecordContent;
