    ...
    (focusArea: FOCUS_AREA_DATA, index: number) => {
      ...
      return {
        ...
        cards: focusArea?.team_rituals?.map((ritual) => ({
          ...
          onLearnMore: () =>
            openInNewTab(`/conversation?focusArea=${focusArea?.focus_area_id}`),
        })),
      };
    },
  );
        ...
        <div className={styles.mainContent}>
          ...
          <div className={styles.sectionBlock}>
            ...
            <div className={styles.sectionIndent}>
              ...
              >
                The aim is not change all at once — it&apos;s steady practice
            ...
            <div className={styles.ritualContent}>
              ...
              <div className={styles.progressText}>
                <p>
                  ...
                  you&apos;ve shown up — what you&apos;ve tried, reflected on,
                  and shaped with others.
                </p>
                <p>
                  It means when it comes to PDRs, annual reviews, or development
                  conversations, you&apos;re not starting from scratch or
                  relying on memory.
                </p>
                <p>
            ...
            <div className={styles.bottomActions}>
              <div className={styles.shareBlock}>
                <div className={styles.shareText}>
                  Enjoying Hi Humaniser!™ ? Share it with someone who&apos;d
                  love it too.
                </div>
