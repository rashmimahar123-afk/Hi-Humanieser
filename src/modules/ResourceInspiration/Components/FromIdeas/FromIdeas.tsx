  ...
  return (
    ...
    >
      ...
      <div className=" text-center">
        <h2
          className="text-[56px] text-[#0F4F58]"
          style={{ fontFamily: "RocaTwo-Bold" }}
        >
          From Ideas To Everyday
        </h2>

        <p className="mt-6 text-[26px] text-[#0F4F58] font-medium">
          This Is Where Hi Humaniser! Moves From Understanding To Doing
        </p>
      </div>

      <div className="relative mt-[100px] ml-[40px] w-[760px] h-[260px]">
        {/* Polygon Background */}
        <Image
        ...
        <div className="ml-[28px]">
          ...
          <div className="text-[#0F4F58] text-[23px] font-[Roboto] mb-8 font-[400]">
            ...
            <ul className="list-disc ml-[38px] space-y-1 ">
              ...
              <li>
                Practical actions you can apply in real meetings, conversations,
                and decisions
              </li>
            </ul>
          </div>
      ...
      <div className="flex justify-center max-w-[1100px] mx-auto flex-col gap-10 mt-[70px]">
        <Image
        ...
        <div className="relative z-10 max-w-[860px]">
          ...
          <div className="space-y-6 text-[20px] text-[#0F4F58] leading-[150%]">
            <p>
              As you complete Pathways, try micro-actions, and take part in Team
              Rituals, your practice is captured automatically in your
            ...
            <p>
              The story of your contribution is already there — grounded in real
              moments, not last-minute summaries.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between mt-14">
          <div className=" flex">
            <div className="max-w-[350px] text-[#0F4F58] font-[Aptos] text-[17px]">
              Enjoying Hi Humaniser!™ ? Share it with someone who’d love it too.
            </div>
