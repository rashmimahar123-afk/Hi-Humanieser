...
function PrivacyPolicy() {
  return (
    <div>
      <main className="relative bg-[#F5F0EB] min-h-screen overflow-hidden">
        {/* Background Shapes */}
        <Image
        ...
        <div className="relative z-10 w-full px-6 md:px-20 py-16">
          {/* LEFT CONTENT */}
          <section>
            <div>
              <p className="text-[37px] leading-[100%] text-[#0F4F58] font-[Roboto] font-[400]">
                Welcome to Hi Humaniser!™, a platform created by Humanising Our
                Workplaces Ltd (“we”, “us”, “our”). We’re committed to
            ...
            <div className="mt-[70px]">
              ...
              <p className="section-text">
                ...
                contact.us@humansingourworkplaces.com
              </p>
            </div>
            <div className="flex justify-center mt-[40px]">
              <PrivacyPolicyDivider />
            ...
            <div className="mt-[70px]">
              ...
              {/* Intro text */}
              <p className="section-text">
                We may use cookies and analytics tools to understand how people
                use the platform and improve usability. You can control cookies
            ...
            <div className="space-y-1 section-text mt-[70px]">
              <p>
                ...
                <span className="font-medium">
                  contact.us@humanisingourworkplaces.com
                </span>
              </p>
            ...
            <p className="mt-[20px] section-text">
              We simply use it to make workplaces — and the systems behind them
              — more human.
            </p>
          </section>
