        ...
        <div className="relative z-10 mt-8">
          ...
          <div className="ml-12">
            ...
            <p className="text-[#0F4F58] text-[22px] leading-relaxed max-w-[1300px]">
              This hub gives you visibility across the system, so you can
              maintain alignment, support your Champions, and keep performance
        ...
        <div className="mt-[150px] ">
          ...
          >
            ...
            <div
              className={`${styles.card} bg-[#f8e1b8] cursor-pointer`}
              onClick={() =>
                router.push("/overseer-hub/organisation-diagnostic")
              }
            >
              {/* Image layer */}
              <div className={styles.imageWrapper}>
