...
const EVENT = "SEND_INVITATION_MODAL_EVENT";

export const openSendInvitationModal = () => {
  emitEvent(EVENT);
};
    ...
    <Dialog open={isOpen} onClose={() => {}} className="relative z-[9999]">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <DialogPanel className="w-full max-w-[520px] rounded-[28px] bg-[#FBE6BF] p-8 text-center space-y-6">
          ...
          <p className="text-[18px] leading-[1.4] text-[#567F55] px-2">
            If they’re curious, they’ll receive a link to explore Hi Humaniser!™
            and discover how work can feel clearer, more connected, and more
            human.
          </p>
          <p className="text-[18px] leading-[1.4] text-[#567F55] px-2">
            Thanks for helping the ripple grow.
          </p>
