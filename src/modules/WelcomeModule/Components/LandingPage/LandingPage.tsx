...
//         {/* Text Overlay */}
//         <div className="absolute inset-0 flex left-[5%] sm:left-[12%] top-[12%] sm:top-[18%] items-center px-4">
//           <p className={`text-center font-bold text-sm sm:text-base ${styles.infoBoxText}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="space-y-8 ">
            ...
            <div className={`space-y-4 ${styles.description}`}>
              ...
              <p className={`text-base text-[#0F4F58] ${styles.descParagraph}`}>
                Explore your pathway, connect with your team, and shape a culture where humans thrive and results follow.
              </p>
            </div>
          ...
          <div className="relative px-4 lg:px-0">
            <div className="relative">
              <div className={`inline-flex justify-center items-center mt-6 ${styles.goBtn}`}>
