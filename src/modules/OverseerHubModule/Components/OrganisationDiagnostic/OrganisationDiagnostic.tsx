    ...
    <div className="relative min-h-screen bg-[#F3EEE7] px-10 py-10 z-10 font-serif">
      ...
      <div className="relative z-10 mt-16">
        ...
        <div className="ml-12">
          <p className="text-[#0F4F58] text-[22px] leading-relaxed font-bold">
            Understand how work is really experienced across your organisation,
            from clarity to ownership.
          </p>
          <p className="text-[#0F4F58] text-[22px] leading-relaxed mt-10">
            A simple, repeatable check-in that helps you see where the system is
      ...
      <div className="mt-[150px] flex items-start gap-16 relative z-20">
        ...
        <div className=" flex flex-col items-center">
          ...
          {/* Preview Questions */}
          <button className="mt-4 text-[#0F4F58] underline text-[16px] font-[Roboto]">
            Preview Questions
          </button>
        </div>
        ...
        <div className="max-w-[700px]">
          <p className="text-[#0F4F58] text-[20px] leading-relaxed font-[Roboto]">
            Start this check-in to understand how work is really experienced
            across your organisation. Results are shown as five simple metrics,
            helping you see where things are working and where support may be
            needed.
          </p>

          <p className="text-[#0F4F58] text-[20px] mt-6 font-[Roboto]">
      ...
      <div className="mt-16">
        {/* Heading */}
        <h2 className="text-[#0F4F58] text-[32px] font-[RocaTwo] mb-6">
          Survey Status
        </h2>
        ...
        <div className="relative mt-6 rounded-xl overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-16 mt-2 ml-8">
            ...
            <div>
              ...
              <div className="bg-[#b9cbb7] rounded-2xl p-8 space-y-3">
      ...
      <div className="mt-16 flex items-start gap-16 relative z-20">
        ...
        <div>
          <p className="text-[#0F4F58] text-[20px] leading-relaxed font-[Roboto]">
            Run this check-in again to track how things are evolving over time.
          </p>

          <p className="text-[#0F4F58] text-[20px]  font-[Roboto] leading-[100%]">
            Most organisations run this every 4–6 months, once changes have had
            time to take effect.
          </p>
        </div>
      </div>
        ...
        <div className="relative mt-6 rounded-xl overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-16 mt-2 ml-8">
                ...
                {comparisonData.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <ProgressPill label={item.label} percent={item.percent} />
            ...
            <div className="max-w-[600px]">
              ...
              <div className="bg-[#b9cbb7] rounded-2xl p-10 space-y-10 text-[#0F4F58] text-[18px] leading-relaxed font-[Roboto] ">
                <p>
                ...
                <p>People raise concerns and see them handled constructively</p>
